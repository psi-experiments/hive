  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-[var(--color-bg)] relative">
      ...
      <header className="shrink-0 bg-[var(--color-surface)] border-b border-[var(--color-border)] px-5 py-3 flex items-center">
        <Link href="/" className="w-7 h-7 rounded border border-[var(--color-border)] flex items-center justify-center text-[var(--color-text-secondary)] hover:text-[var(--color-text)] hover:border-gray-400 hover:bg-[var(--color-layer-2)] transition-all mr-4">
